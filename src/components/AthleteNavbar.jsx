  ...
  return (
    <>
      <style>{`
                ...
                .sc-logo-glow:hover {
                    filter: drop-shadow(0 0 12px rgba(29,168,255,0.4));
            ...
            <Link to="/" className="flex items-center gap-2.5 group sc-logo-glow flex-shrink-0">
              <div className="relative">
                <img
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 object-contain relative z-10"
                />
              ...
              <div className="flex flex-col leading-none">
                <span className="sc-logo-text text-white text-xl sm:text-2xl tracking-widest leading-none">
                  SPORTS
                </span>
                <span className="sc-logo-text text-[#1DA8FF] text-xl sm:text-2xl tracking-widest leading-none -mt-0.5">
                  CONNECT
                </span>
              </div>
            </Link>
              ...
              {navLinks.map(({ label, to }) => {
                ...
                return (
                  <Link
                    key={to}
                    to={to}
                    className={`sc-nav-link relative px-3 py-1.5 text-sm font-semibold transition-colors ${isActive
            ...
            <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div className="sc-dropdown absolute right-0 top-11 w-64 bg-[#161B22] border border-white/8 rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div className="border-t border-white/5 px-3 py-2">
                      ...
                      {["#InterSchoolsFinals", "#RecruitSeason2026", "#GhanaAthletics"].map(t => (
                        <button key={t} className="w-full text-left text-[#1DA8FF] text-xs py-1 hover:text-white transition-colors font-medium">
                          {t}
                        </button>
                      ))}
                    </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: dark ? "rgba(251,191,36,.08)" : "rgba(99,102,241,.08)",
                }}
              >
                  ...
                  <div className="sc-dropdown absolute right-0 top-11 w-52 bg-[#161B22] border border-white/8 rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div className="px-4 py-3 border-b border-white/5">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p className="text-white text-xs font-bold">James Junior</p>
                          <p className="text-gray-600 text-xs">@jamesjnr_cb</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border-t border-white/5">
                      <button className="w-full flex items-center gap-2.5 px-4 py-2.5 text-red-400 hover:text-red-300 hover:bg-red-500/5 transition-colors text-sm">
